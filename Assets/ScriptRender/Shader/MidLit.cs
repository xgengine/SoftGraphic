...
public class MidLit:ScriptShader
{
    ...
    public override Color frag(List<Vector4> IN)
    {
        ...
        float L = Vector3.Dot(worldNormal, worldLightDir);
        float H = Vector3.Dot(Hvl, worldNormal);
        

       
        c = (c+ (_Speculer *100+ 8)/(8*3.14f)*_SpecColor*  Mathf.Pow(H, _Speculer * 100)  )*L;
